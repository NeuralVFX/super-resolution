...
- This uses RNN style upressing, re-using the same weights for each up-res stage. After "rnn_switch_epoch", these weights are copied and the weights for each layer are made individual
